...
class LorentzFC(nn.Module):
    def __init__(self, in_features: int, out_features: int, manifold: Lorentz = Lorentz(0.1), reset_params: str = "eye", a_default=0.0, activation: nn.Module = nn.functional.relu) -> None:
        super().__init__()
